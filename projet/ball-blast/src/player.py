import os
import pygame
from constantes import SCREEN_WIDTH, SCREEN_HEIGHT, PLAYER_SPEED
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        canon_path = os.path.join(IMAGES, "canon.png")
        self.image = pygame.transform.scale(
            pygame.image.load(canon_path).convert_alpha(),
            (33, 66)
        )
...
class Wheel(pygame.sprite.Sprite):
    def __init__(self, xoffset):
        ...
        wheel_path = os.path.join(IMAGES, "wheel.png")
        self.original_image = pygame.transform.scale(
            pygame.image.load(wheel_path).convert_alpha(),
            (25, 25)
        )
