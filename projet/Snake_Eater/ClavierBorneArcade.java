package projet.Snake_Eater;

import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;

/**
 * Cette classe implémente les méthodes de KeyListener permettant la gestion du
 * clavier.
 * <br />
 * <br />
 * Elle permet de gérer le clavier dans des applications développées pour la
 * borne d'arcade de l'IUT.<br />
 * 
 * Les joysticks sont nommés joyJ1 et joyJ2. joyJ1Haut la touche envoyée lorsque
 * le joystick 1 est poussé vers le haut, joyJ1Bas, joyJ1Gauche, joyJ1Droite
 * lorsqu'il est poussé, respectivement, vers le bas, la gauche et la
 * droite.<br />
 *
 * Les boutons sont nommés boutonJ1 et boutonJ2. Il y a 6 boutons possibles pour
 * chaque joueur. Ils sont notés A, B et C pour les boutons du bas et X, Y et Z
 * pour les boutons du haut. Ils sont donc notés boutonJ1A, boutonJ1B,
 * boutonJ1C, boutonJ1X, boutonJ1Y et boutonJ1Z.<br />
 *
 * Pour chacune des directions des joysticks ou des boutons, deux méthodes
 * seront présentes : une méthode pour savoir si la direction ou le bouton est
 * pressé ou une autre méthode pour savoir s'il a été pressé.
 *
 * Elle fonctionne sur le principe de booléen que l'on change quand on appuie ou
 * relâche les touches.
 */
public class ClavierBorneArcade implements KeyListener {
    ...
    /**
     * Crée un clavier et initialise tous les attributs à faux pour touches
     * relâchés.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "flèche
     *         gauche" : vrai pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "flèche
     *         gauche tapée" : vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "flèche
     *         droite" : vrai pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "flèche
     *         droite tapée" : vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "flèche haut"
     *         : vrai pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "flèche haut
     *         tapée" : vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "flèche bas"
     *         : vrai pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "a" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "a tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "z" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "z tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "e" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "e tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "q" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "q tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "s" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "s tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "d" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "d tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "k" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "k tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "l" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "l tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "m tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "m" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "o" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "o tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "f tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "f" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "g tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "g" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "h tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "h" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "r tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "r" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "t tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "t" : vrai
     *         pour enfoncée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "y tapée" :
     *         vrai pour tapée, faux sinon.
     */
     ...
     * 
     * @return retourne la valeur du booléen correspondant à la touche "y" : vrai
     *         pour enfoncée, faux sinon.
     */
    ...
    /**
     * Méthode permettant la reinitialisation du clavier. Reinitialisation de tous
     * les événements.
     */
    ...
    /**
     * Implémentation de la méthode KeyReleased - méthode appelée automatiquement
     * lors d'un événement clavier.
     * <br />
     * <br />
     * Elle permet de mettre à jour les valeurs des attributs en fonction des
     * interactions au clavier.<br />
     * Ici, si une touche est relâchée, l'attribut gérant cette touche est mis à
     * jour.<br />
     * Pour la gestion sur l'appui des touches, voir la méthode keyPressed (
     * KeyEvent k ).
     * 
     * @param key un événement clavier.
     * @see <a href=
     *      "https://docs.oracle.com/javase/7/docs/api/java/awt/event/KeyEvent.html"
     *      target="_blank">KeyEvent</a>
     * @see <a href=
     *      "https://docs.oracle.com/javase/7/docs/api/java/awt/event/KeyListener.html"
     *      target="_blank">KeyListener</a>
    ...
    /**
     * Implémentation de la méthode KeyTyped - méthode appelee automatiquement lors
     * d'un événement clavier.
     * <br />
     * <br />
    ...
    /**
     * Implémentation de la méthode KeyPressed - méthode appelee automatiquement
     * lors d'un événement clavier.
     * <br />
     * <br />
     * Elle permet de mettre a jour les valeurs des attributs en fonction des
     * interactions au clavier.<br />
     * Ici, si une touche est pressee, l'attribut gerant cette touche est mis a
     * jour.<br />
     * Pour la gestion du relachement des touches, voir la méthode keyReleased (
     * KeyEvent k ).
     * 
     * @param key un événement clavier.
     * @see <a href=
