 ...
 * Une texture est une image rectangulaire qui peut être affichée dans la zone
 * d'affichage. La transparence est gérée. Les formats d'images supportées sont
 * : gif, jpg, png et bmp.<br />
 * Contrairement aux rectangles, la modification des points A ou B (des coins
 * bas gauche ou haut droit) ne changent pas la dimension de l'image. Pour
 * modifier la taille de l'image, il vous faudra passer par les méthodes
 * setHauteur et setLargeur.<br />
 * Si une couleur est spécifiée lors de la construction de l'objet (noir sinon),
 * que l'image utilise la transparence et que l'on demande à afficher la forme
 * pleine alors la couleur sera utilisée comme fond.<br />
...
public class Texture extends Rectangle {
     ...
     * 
     * @exception java.lang.RuntimeException Ce constructeur ne prenant pas de
     *                                       parmètre ne fait que lancer
     *                                       l'exception.
     * @see <a href=
     *      "https://docs.oracle.com/javase/7/docs/api/java/lang/RuntimeException.html"
     *      target="_blank">RuntimeException</a>
     */
    public Texture() {
        throw new java.lang.RuntimeException(
                "Le constructeur par défaut de Texture ne peut être appelé. Il faut au moins spécifier une image.");
    }
    ...
    /**
     * Construit une Texture à partir d'un chemin vers un fichier image et d'un
     * Point.<br />
     * <br />
     * <br />
     * La taille de l'image correspondra à la taille réelle de l'image. Elle ne sera
     * pas déformée.<br />
     * Par défaut, la transparence est activée.
     * 
     * @param chemin Chaîne de caractères représente le chemin d'accès vers l'image.
     * @param a      Position du coin bas gauche de l'image dans la zone
     *               d'affichage.
     * @see Point
     */
    public Texture(String chemin, Point a) {
        ...
        try {
            ...
            System.out.println(
                    "[!] Erreur : L'image " + chemin.substring(1, chemin.length()) + " est introuvable.\n" + e);
        }
    ...
    /**
     * Construit une Texture à partir d'un chemin vers un fichier image, d'un Point,
     * une largeur et une hauteur.<br />
     * Par défaut, la transparence est activée.
     * 
     * @param chemin Chaîne de caractères représente le chemin d'accès vers l'image.
     * @param a      Position du coin bas gauche de l'image dans la zone
     ...
     * @param chemin  Chaîne de caractères représente le chemin d'accès vers
     *                l'image.
     * @param a       Position du coin bas gauche de l'image dans la zone
     *                d'affichage.
     * @see Couleur
    ...
    /**
     * Construit une Texture à partir d'un chemin vers un fichier image, d'un Point,
     * d'une largeur et d'une hauteur.<br />
     * Par défaut, la transparence est désactivée.
     * 
     * @param couleur Couleur de fond
     * @param chemin  Chaîne de caractères représente le chemin d'accès vers
    ...
    /**
     * Retourne la hitbox - ensemble de primitives géométriques formant la hitbox de
     * la texture.
     * 
     * @return Une liste contenant l'ensemble des primitives gégométriques formanant
     *         la hitbox.
     */
    ...
    /**
     * Permet de modifier la position du point A. La position du point B est
     * également modifiée afin que la texture ne soit pas étirée.
     * 
    ...
    /**
     * Permet de modifier la position du point B. La position du point A est
     * également modifiée afin que la texture ne soit pas étirée.
     * 
     ...
     * <br />
     * <br />
     * On vérifie d'abord si l'image est transparente ou non, puis on utilise la
     * méthode drawImage adéquate.
     * 
     * @param g Graphics.
     */
    public void afficher(Graphics g) {
        ...
        if (getTransparent())
            g.drawImage(img, this.getA().getX(),
                    (int) g.getClipBounds().getHeight() - this.getA().getY() - getHauteur(), getLargeur(), getHauteur(),
                    null);
    ...
    /**
     * Méthode equals permettant de tester l'égalité entre une texture et un objet
     * passé en paramètre.
     * 
     * @return Vrai si l'objet passé en paramètre est une texture dont les
     *         caractéristiques sont les mêmes que la texture sur lequel la méthode
     *         est appelée.
     */
    ...
    /**
     * Teste l'intersection entre une primitive géométrique et la hitbox de la
     * texture (si elle existe).
     * 
     * @param d une primitive géométrique
     * @return vrai s'il y a intersection entre la primitive géométrique passé en
     *         paramètre et la hitbox de la texture, faux sinon.
     */
     ...
     * 
     * @param t une texture
     * @return vrai s'il y a intersection entre la hitbox des deux textures, faux
     *         sinon.
     */
