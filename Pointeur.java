...
public class Pointeur {
     ...
     * Initialise les textures de sélection et positionne le pointeur sur le dernier
     * jeu.
     */
    public Pointeur() {
     ...
     * Exécute le script shell correspondant au jeu et attend sa fin avant de
     * reprendre le menu.
    ...
    public void lancerJeu(ClavierBorneArcade clavier) {
        if (clavier.getBoutonJ1ATape()) {
            try {
                ...
                // scripts are stored in Script/ relative to repository root
                Process process = Runtime.getRuntime()
                        .exec("./Script/" + Graphique.tableau[getValue()].getNom() + ".sh");
